<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $npa=$_POST['npa'];
        include 'db.php';
        $qt="select password from organization where username='$username';";
        ...
        $q="update organization set password='$np' where username='$username';";
...
<div class="login-form">
    <form action="" method="post">
        ...
        <div class="form-group">
            <input type="password" class="form-control" name="cp"  placeholder="Password" required="required">
        </div>
        <div class="form-group">
            <input type="password" class="form-control" name="np"  placeholder="Password" required="required">
        </div>
		<div class="form-group">
