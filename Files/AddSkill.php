<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $q="insert into skills(username,skillname,percentage) values('$username','$name','$percentage');";
...
<div class="login-form">
    <form action="" method="post">
        <h2 class="text-center">Add Skills</h2>       
        <div class="form-group">
            <input type="text" class="form-control" name="Name" placeholder=" Skill Name(JAVA,HTML)" required="required">
        </div>
