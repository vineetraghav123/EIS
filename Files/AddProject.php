<?php
    session_start();
    if(!isset($_SESSION['username']) and !isset($_GET['u']) ){
    ...
    if(isset($_POST['submit'])){
        ...
        include 'db.php';
        $q="insert into projects(username,name,duration,description,url) values('$username','$name','$duration','$description','$url');";
